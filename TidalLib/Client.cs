...
namespace TidalLib
{
    public class Client
    {
        ...
        private static Dictionary<string, string> API_KEY = new Dictionary<string, string>() { { "clientId", "rUKwxIkzDdWZTokq" } , { "clientSecret", "5q2msmj7qXlWXeRZDSPPIOlkvfSePURPmija1EIuIzk=" } };
